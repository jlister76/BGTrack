(function (window, angular, undefined) {
  ...
  /**
   * @ngdoc object
   * @name lbServices.GlucoseTest
   * @header lbServices.GlucoseTest
   * @object
   *
   * @description
   *
   * A $resource object for interacting with the `GlucoseTest` model.
   *
   * ## Example
   *
   * See
  ...
  module.factory(
    ...
    ['LoopBackResource', 'LoopBackAuth', '$injector', function (Resource, LoopBackAuth, $injector) {
      var R = Resource(
        urlBase + "/GlucoseTests/:id",
        {'id': '@id'},
        {

          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#create
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
           * Create a new instance of the model and persist it into the data source.
           ...
           * <em>
           * (The remote method definition does not provide any description.
           * This usually means the response is a `GlucoseTest` object.)
           * </em>
           */
          "create": {
            url: urlBase + "/GlucoseTests",
            method: "POST"
          },

          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#createMany
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
          ...
          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#upsert
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
          ...
          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#exists
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
           ...
           */
          "exists": {
            url: urlBase + "/GlucoseTests/:id/exists",
            method: "GET"
          },

          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#findById
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
           ...
           */
          "findById": {
            url: urlBase + "/GlucoseTests/:id",
            method: "GET"
          },

          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#find
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
          ...
          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#findOne
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
           ...
           */
          "findOne": {
            url: urlBase + "/GlucoseTests/findOne",
            method: "GET"
          },

          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#updateAll
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
           ...
           */
          "updateAll": {
            url: urlBase + "/GlucoseTests/update",
            method: "POST"
          },

          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#deleteById
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
          ...
          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#count
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
           ...
           */
          "count": {
            url: urlBase + "/GlucoseTests/count",
            method: "GET"
          },

          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#prototype$updateAttributes
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
          ...
          /**
           * @ngdoc method
           * @name lbServices.GlucoseTest#createChangeStream
           * @methodOf lbServices.GlucoseTest
           *
           * @description
           *
           ...
           */
          "createChangeStream": {
            url: urlBase + "/GlucoseTests/change-stream",
            method: "POST"
          },
        }
      );
      ...
      /**
       * @ngdoc method
       * @name lbServices.GlucoseTest#updateOrCreate
       * @methodOf lbServices.GlucoseTest
       *
       * @description
       *
      ...
      /**
       * @ngdoc method
       * @name lbServices.GlucoseTest#update
       * @methodOf lbServices.GlucoseTest
       *
       * @description
       *
      ...
      /**
       * @ngdoc method
       * @name lbServices.GlucoseTest#destroyById
       * @methodOf lbServices.GlucoseTest
       *
       * @description
       *
      ...
      /**
       * @ngdoc method
       * @name lbServices.GlucoseTest#removeById
       * @methodOf lbServices.GlucoseTest
       *
       * @description
       *
      ...
      /**
       * @ngdoc property
       * @name lbServices.GlucoseTest#modelName
       * @propertyOf lbServices.GlucoseTest
       * @description
       * The name of the model represented by this $resource,
       * i.e. `GlucoseTest`.
       */
      R.modelName = "GlucoseTest";
